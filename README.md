...
### 💡 About Me  
- 🔭 Working on a Mood Analyzer project  
- 🌸 I love clean UI designs 
- 🎮 Sometimes building games and lobbies on Roblox Studio  

---

### 🛠 Tech Stack  
`Python` `C` `HTML` `CSS` `Java` `React` `TensorFlow` `Git` `Machine Learning` `Computer Vision`
